The codebase proves the posibility to use Razor components within Razor Pages as described in the documentation: <br>
...
The adjusted code reflects the changes described in the discussion.
